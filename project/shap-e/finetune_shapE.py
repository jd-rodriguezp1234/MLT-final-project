...
class shapE_train_dataset(Dataset):
    def __init__(self, latent_code_path):
        ...
        self.valid_uid = list(pickle.load(open('/home/estudiante/dataset/train_organs.pickle','rb')))
...
class shapE_val_dataset(Dataset):
    def __init__(self, latent_code_path):
        self.captions = pd.read_csv('/home/estudiante/dataset/organs_selected_complete.csv', header=None)
        self.valid_uid = list(pickle.load(open('/home/estudiante/dataset/val_organs.pickle','rb')))
        self.final_uid = self.valid_uid
        self.n2idx = {}
        for i in range(len(self.captions)):
            self.n2idx[self.captions[0][i]] = i
            ...
            if skip_step:
                ...
                if (i == 0):
                    ...
                    with torch.no_grad():
                        ...
                        writer.writerow([time.time()-s2, epoch, i+1, step_count, train_mean_loss, val_mean_loss, final_loss.item()])
